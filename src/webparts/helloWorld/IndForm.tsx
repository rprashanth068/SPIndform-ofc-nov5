...
<div className="row">
        ...
        <div className="row">
          ...
          <div className="form-group tax">
              <label htmlFor="formGroupExampleInput">GST#</label>
              <input type="text" className="form-control" id="formGroupExampleInput" placeholder=" " maxLength={17}/>
            </div>
          </div>
          <div className="col-2">
          <div className="form-group tax">
              <label htmlFor="formGroupExampleInput">HST#</label>
              <input type="text" className="form-control" id="formGroupExampleInput" placeholder=" " maxLength={17} />
            </div>
          </div>
          <div className="col-2">
          <div className="form-group tax">
              <label htmlFor="formGroupExampleInput">PST#</label>
              <input type="text" className="form-control" id="formGroupExampleInput" placeholder=" " maxLength={8} />
            </div>
          </div>
          <div className="col-2">
          <div className="form-group tax">
              <label htmlFor="formGroupExampleInput">QST#</label>
